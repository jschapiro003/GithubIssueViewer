...
var IssueView = _react2['default'].createClass({ displayName: 'IssueView', 
	...
	render: function render() {
		...
		if (this.props.params.number !== undefined) {
			var _issue = _IssueStoreJs2['default'].getIssue(this.props.params.number);}


		var issueLabels = issue.labels ? issue.labels.map(function (label) {
