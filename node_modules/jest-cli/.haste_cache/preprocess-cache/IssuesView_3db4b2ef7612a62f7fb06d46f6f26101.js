...
var $ = require('jquery');var apiStart = 0;
var apiEnd = 25;
...
var IssuesView = _react2['default'].createClass({ displayName: 'IssuesView', 
		...
		render: function render() {
				...
				return (
						...
						_react2['default'].createElement('div', { style: styles.header }, ' GithubIssueViewer.js', 
						_react2['default'].createElement('img', { src: '../../assets/githubicon.png', width: '25px', height: '25px' }, ' ')), 
